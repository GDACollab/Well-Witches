    ...
    void Update()
    {
        ...
        switch (Active)
        {
            ...
            case "SharingIsCaring":
                ...
                ActiveIcon.GetComponent<RectTransform>().sizeDelta = Icons[4].Size() / 2;
                break;
            case "BubbleBarrier":
                ActiveIcon.GetComponent<RawImage>().texture = Icons[5];
                ActiveIcon.GetComponent<RectTransform>().sizeDelta = Icons[5].Size() / 2;
                break;
        }
        ...
        switch (Passive)
        {
            case "AloeVera":
                ...
                PassiveIcon.GetComponent<RectTransform>().sizeDelta = Icons[0].Size() / 2;
                break;
            case "HellfireBooties":
                PassiveIcon.GetComponent<RawImage>().texture = Icons[1];
                PassiveIcon.GetComponent<RectTransform>().sizeDelta = Icons[1].Size() / 2;
                break;
            case "Espresso":
                PassiveIcon.GetComponent<RawImage>().texture = Icons[2];
                PassiveIcon.GetComponent<RectTransform>().sizeDelta = Icons[2].Size() / 2;
                break;
            default:
