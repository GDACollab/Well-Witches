...
VAR CollectPumpkinQuestID = "CollectPumpkinQuest"

// quest states (quest id + "State" for variable name)
VAR CollectPumpkinQuestState = "REQUIREMENTS_NOT_MET"
-> Dialogue
=== Dialogue ===
{ CollectPumpkinQuestState :
...
* [Yes]
    ~ StartQuest("CollectPumpkinQuest")
...
~currentSpeaker = "Dullahan"
Let me finish. It was the finest piece by the best artist in the land. #sprite:headlessExcited
...
~currentSpeaker = "Dullahan"
Actually… it was. How did you know that?  #sprite:headlessShocked
~currentSpeaker = "Player"
...
~currentSpeaker = "Player"
How <i>generous</i> of you. #speaker:warden #sprite:anger1
...
~ FinishQuest("CollectPumpkinQuest")
