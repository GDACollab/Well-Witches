...
//First time a player dies + ability gain
 ...
 Who…are you? #speaker:warden  #sprite: confused
	...
	~currentSpeaker = "Parcella"
 I have a special boo-livery for you! The name is Parcella, your friendly neighborhood ghost! #sprite: excited

	~currentSpeaker = "Player"
 A boo-livery? #speaker:gatherer #sprite: surprised

	~currentSpeaker = "Parcella"
Uh-huh! When ya both fainted I found both of your belongings on the ground! I figured I’d bring them back to you. #sprite: pleased

	~currentSpeaker = "Player"
 What’s the catch here? #speaker:warden

	~currentSpeaker = "Parcella"
 Nothing! #sprite: excited
 ...
 …?! #speaker:gatherer
	...
	~currentSpeaker = "Parcella"
Anytime you lose your belongings I’ll be sure to return them to you! Here’s a gift to celebrate our first time meeting! #sprite: excited

 Here Vervain: defy death, unlike me, with the ability Resurrection Regalia! And Aloe, help others with Aloe Vera!
 ...
 Parcella? I'm curious to how you became a ghost mailperson? #speaker:gatherer #sprite: thinking
	...
	~currentSpeaker = "Parcella"
 I did it because delivering mail helps people! Just like it helps you both! #sprite: pleased
 
	~currentSpeaker = "Player"
 Wait, but how did you become a ghost in the first place? #speaker:warden #sprite: confused

	~currentSpeaker = "Parcella"
 When I was human I contracted Soft Bones Fever. It’s a rare disease that makes your bones flexible, so my body was weak my whole human life. #sprite: thinking

	~currentSpeaker = "Player"
Oh Parcella! I’m sorry about that... #speaker:gatherer #sprite: confused

	~currentSpeaker = "Parcella"
 It’s okay! I became a ghost because I accidentally fell onto a pile of mail! #sprite: excited
